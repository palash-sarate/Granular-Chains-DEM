...
def main():
    ...
    p_fill.add_argument("--mol_dir")
    p_fill.add_argument("--setup_inc", default="simulation_geometries/2D_hopper_with_orifice_cover.inc")
    p_fill.add_argument("--dump_inc", default="simulation_templates/default_dump.inc")
    p_fill.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_resume_h.add_argument("--mol_dir")
    p_resume_h.add_argument("--setup_inc", default="simulation_geometries/2D_hopper_with_orifice_cover.inc")
    p_resume_h.add_argument("--dump_inc", default="simulation_templates/default_dump.inc")
    p_resume_h.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_flop.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_resume_f.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_batch.add_argument("--viscosities", default="0.000001")
    ...
    p_grid.add_argument("--dump_file", default="simulation_templates/default_dump.inc")
    ...
    p_grid_h.add_argument("--hopper_template_data", default="simulation_geometries/2D_hopper_with_orifice_cover.inc")
    p_grid_h.add_argument("--lepton_file", default="simulation_templates/lepton.inc")
    p_grid_h.add_argument("--dump_file", default="simulation_templates/default_dump.inc")
    p_grid_h.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_res_grid.add_argument("--dump_file", default="simulation_templates/default_dump.inc")
    p_res_grid.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_flow.add_argument("--dump_file", default="simulation_templates/default_dump.inc")
    p_flow.add_argument("--viscosity", type=float, default=0.000001)
    ...
    p_res_flow.add_argument("--viscosity", type=float, default=0.000001)
